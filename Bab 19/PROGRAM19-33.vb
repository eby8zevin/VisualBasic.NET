...
Module Program  
  Sub Main()
    ...
    list1.Add( _
      New Penerbit("P01", "Angkasa Media"))
    list1.Add( _
      New Penerbit("P02", "Sinar Media"))
    list1.Add( _
      New Penerbit("P03", "Promedia"))
    ...
    Dim hasil As IEnumerable(Of View) = _
      list1.Join(list2,
            Function(penerbit) penerbit.ID,
            Function(buku) buku.IDPenerbit,
            Function(penerbit, buku) New View(buku.Judul, _ 
                                           penerbit.Nama, _
                                           buku.Harga))    
