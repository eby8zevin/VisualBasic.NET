...
Module Program
  Sub Main()
    ...
    'mengisi nilai data melalui properti pengindeks
    obj.Fields(0) = 8
    obj.Fields(1) = 6
    'obj(2) = 4   'salah
    
    'mengambil nilai data melalui properti pengindeks
    Console.WriteLine("panjang {0}= {1}", vbTab, obj.Fields(0))
    Console.WriteLine("lebar {0}= {1}", vbTab, obj.Fields(1))
    Console.WriteLine("Luas {0}= {1}", vbTab, _
      obj.Fields(0) * obj.Fields(1))
