...
Class KelasTurunan: Inherits KelasDasar
  'akan menimpa/menyembunyikan data KelasDasar.bilangan
  'tanpa menimbulkan pesan peringatan
  'pada saat kompilasi kode program
  Shadows Private bilangan As Integer
