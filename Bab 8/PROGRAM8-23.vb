...
Module Program
  Sub Main()
    ...
    Dim persegipanjang As Segiempat = _
      New Segiempat(10,5)
    persegipanjang.CetakLuas("persegi panjang")
    
    'membuat objek dari kelas Segiempat
    Dim bujursangkar As Segiempat = _
      New Segiempat(8)
    bujursangkar.CetakLuas("bujursangkar")
    
    'membuat objek dari kelas Segitiga
    Dim segitiga As Segitiga = _
      New Segitiga(4,3)
    segitiga.CetakLuas("segitiga")
    
    'membuat objek dari kelas Lingkaran
    Dim lingkaran As Lingkaran = _
      New Lingkaran(3)
    lingkaran.CetakLuas("lingkaran")
